...
=======================  ========================================================================
<integer_list>           seven integers, with a value either zero (0) or one (1).
=======================  ========================================================================

A further degree of control is offered by the seven integers (i\ :sub:`1` through i\ :sub:`7`) that identify
which solution variables will contribute to the error norm calculations. Permissible
values for each of these seven integers are 0 and 1. The correspondence between the
integers and variables is as follows:
...
A value of 0 for an integer directs *Goma* to exclude contributions from that variable in
the error norm calculation; correspondingly, a value of **1** means that variable should be
included.
