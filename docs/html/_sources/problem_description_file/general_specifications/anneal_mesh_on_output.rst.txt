...
no                       Do not set the mesh displacements to zero for the next
                         continuation step. This is the default.
=======================  ========================================================================
...
Annealing a mesh is accomplished by adding the displacements (from the solution) to
...
**read_exoII** option for an *Initial Guess*.
