...
============   ==========================================================
   **yes**     This value sets the flag WRITE_INITIAL_SOLUTION variable
               to “TRUE”. The initial solution vector will be written to an
               EXODUS II file and to an ASCII file (if the number of
               processors is not greater than DP_PROC_PRINT_LIMIT,
               currently set to 4 in *rf_io.h*).
============   ==========================================================
