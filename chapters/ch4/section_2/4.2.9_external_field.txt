...
+------------------+----------------------------------------------------------------+
| {char_string2}   |   Two- to eight-character value that identifies the type of    |
...
+------------------+----------------------------------------------------------------+
|<file_name>       |   Name of the EXODUS II file from which the nodal field        |
...
+------------------+----------------------------------------------------------------+
|[char_string3]    |   Optional character string. Only optional available is        |
|                  |   **“timedependent”** which enables nodal variables to be      |
