...
====================  ==========================================================================
**none**              No scaling is performed. This is the default if no *Matrix
                      Scaling* card is present.
**Jacobi**            Point Jacobi scaling is performed.
**BJacobi**           Block Jacobi scaling is performed if the underlying matrix
                      format is VBR. If the MSR matrix format is used, the
                      scaling reverts to point Jacobi.
**row_sum**           Scale each row so the sum of the magnitudes of the nonzero
                      elements is 1.
**sym_diag**          Symmetric scaling so that diagonal elements are 1.
**sym_row_sum**       Symmetric scaling using the matrix row sums.
====================  ==========================================================================
